...
public class RobotMap {
    ...
    public static final int armSpike = 1;
    
    public static final Relay.Value armBack = Relay.Value.kForward;
    public static final Relay.Value armForward = Relay.Value.kReverse;
    public static final Relay.Value armStill = Relay.Value.kOff;
}
